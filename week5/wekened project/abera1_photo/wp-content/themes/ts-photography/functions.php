...
define('TS_PHOTOGRAPHY_BUY_NOW','https://www.themeshopy.com/themes/premium-photography-wordpress-theme/','ts-photography');
define('TS_PHOTOGRAPHY_LIVE_DEMO','https://themeshopy.com/ts-photography/','ts-photography');
define('TS_PHOTOGRAPHY_PRO_DOC','https://www.themeshopy.com/demo/docs/photography-pro/','ts-photography');
define('TS_PHOTOGRAPHY_FREE_DOC','https://www.themeshopy.com/demo/docs/free-ts-photography/','ts-photography');
define('TS_PHOTOGRAPHY_CONTACT','https://wordpress.org/support/theme/ts-photography/','ts-photography');
define('TS_PHOTOGRAPHY_CREDIT','https://www.themeshopy.com/themes/free-photography-wordpress-theme/','ts-photography');

if ( ! function_exists( 'ts_photography_credit' ) ) {
	function ts_photography_credit(){
		echo "<a href=".esc_url(TS_PHOTOGRAPHY_CREDIT)." target='_blank'>".esc_html__('Photography Wordpress Theme','ts-photography')."</a>";
	}
}
//* Excerpt Limit Begin */
